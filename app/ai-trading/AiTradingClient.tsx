  ...
  return (
    <main className="pb-16">
      ...
      <section className="container-wide pt-6">
        <a href="/research" className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--card)] px-4 py-2 text-sm text-[var(--muted)] transition hover:border-[var(--gold)] hover:text-[var(--gold)]">
