...
import { ReferralApprovals } from "@/components/ReferralApprovals";
...
const TABS = [
  ...
  { id: "referrals", label: "Referrals", icon: "M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2" },
  { id: "financial", label: "Financial", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1.042M12 8V6m0 12v-2m0-8a3 3 0 00-3 3" },
  ...
  { id: "live-chat", label: "Live Chat", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
];
    ...
    <div className="flex min-h-screen bg-[var(--bg)] text-[var(--fg)] font-sans">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-6 lg:p-8">
          ...
          {/* ═══ LIVE CHAT ═══ */}
          {activeTab === "referrals" && <ReferralApprovals />}

          {/* ═══ FINANCIAL ═══ */}
          {activeTab === "financial" && <FinancialPanel />}

          {activeTab === "live-chat" && <AdminChat me={me} />}
        </div>
      </main>
